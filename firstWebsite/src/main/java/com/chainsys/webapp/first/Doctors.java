...
public class Doctors extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("Get All Doctors Details");
		...
		if(request.getParameter("input").equals("yes")) {
			...
			out.print("<th height=\"10\" width=\"90\">Date_of_birth:</th>");
...
//--------------------------------------------------------------------------------------------------------------------------	
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("ADD NEW DOCTORS STATUS :"+result + "row inserted");
		try {
			out.close();
		}catch(Exception e) {
			e.printStackTrace();
...
//------------------------------------------------------------------------------------------------------------------------	
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("Update Doctors Status :" +result + "row Updated");
		try {
			out.close();
		}catch(Exception e) {
			e.printStackTrace();
...
//----------------------------------------------------------------------------------------------------------	
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("Doctors Delete Status :"+result+"row deleted");
		try {
			out.close();
		}catch(Exception e) {
			e.printStackTrace();
