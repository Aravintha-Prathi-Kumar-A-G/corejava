...
public class EmployeeUi {
	    ...
	    public static void addNewEmployee() {
		    ...
		    float salaryFloat =Float.parseFloat(emp_salary);
			try
		    {
		...
		public static void getAllEmployeesDetails() {
			...
			while(empItr.hasNext()) {
				...
				System.out.println(emp.getEmp_id()+" "+emp.getFirst_name()+" "+emp.getEmp_id()+" "+emp.getSalary()+" "+emp.getEmail()+" "+emp.getHire_date());
			}
		}
